 ...
 * Используется шаблон NavigationDrawer
 *
 */
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         /**
         * При старте активности всегда чекается юзер, и если необходимо меняет
         * пункты NavigationDrawer в зависимости от того авторизован юзер
         * или нет
         */
